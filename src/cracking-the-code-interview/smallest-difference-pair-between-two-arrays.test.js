const { smallestDifferencePairBetweenTwoArrays } = require('./smallest-difference-pair-between-two-arrays')
...
describe('smallestDifferencePairBetweenTwoArrays', () => {
  describe('when string has no duplicates', () => {
    ...
    it('solves [1, 3, 15, 11, 2] and [23,127, 235,19, 8]', () => {
      const result = smallestDifferencePairBetweenTwoArrays([1, 3, 15, 11, 2], [23, 127, 235, 19, 8])
